...
let goodFilters = "教程@软件@极客@你我校@编程@年级@英语@辅导@培训@靓美@性感@内衣@脚气@文胸@看房@鞋带@益生菌@丰胸@课程培训@体验班@精品课@红参@益生元@御夫@御女@种子@手机卡@网易严选@青春期@旅游@苗霸@北海游@购房@情趣@种子@三元催化@男用喷剂@万向轮@档案袋@癣@老太太@妇女@私处@孕妇@卫生巾@卫生条@课@培训@阴道@生殖器@肛门@狐臭@少女内衣@胸罩@洋娃娃@男孩玩具@女孩玩具@少女@女性内衣@女性内裤@女内裤@女内衣@女孩@吊带@黑丝@钢圈@娃娃@网课@网校@电商@钢化膜@网络课程@疣@避孕套@女纯棉@按键贴@背膜@后膜@贝尔思力@神皂@美少女@英语@俄语@四级@六级@四六级@在线网络@在线@阴道炎@宫颈@延时@糜烂@打底裤@早早孕@延时喷剂@鱼@自慰@震动@振动@跳蛋@增长增时@狗".split('@')
let minPrice = 8
...
async function filterGoodList() {
	...
	const now = Date.now()
	const oneMoreDay = now + 30 * 60 * 60 * 1000
...
async function tryGoodList() {
	...
	for (let i = 0; i < $.goodList.length && $.running; i++) {
		...
		await $.wait(Math.floor(Math.random() * 11000 + 4000))
		// 关注完毕，即将试用
		await doTry(good)
	}
}
