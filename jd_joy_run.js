...
//此处填入你需要助力好友的京东用户名
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["jd_4613d00a6a0ef,jd_7eb844fa34b82,jd_7a9adfaa33e88,jd_sNwckLRthfIF,H189178"];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ["jd_4613d00a6a0ef,jd_7eb844fa34b82,jd_7a9adfaa33e88,jd_sNwckLRthfIF,H189178"];
let temp = run_pins[0].split(',')
let fixPins = temp.splice(temp.indexOf('jd_4613d00a6a0ef'), 1);
fixPins.push(...temp.splice(temp.indexOf('jd_4613d00a6a0ef'), 1));
...
let friendsArr = ["jd_4613d00a6a0ef,jd_7eb844fa34b82,jd_7a9adfaa33e88,jd_sNwckLRthfIF,H189178"]
